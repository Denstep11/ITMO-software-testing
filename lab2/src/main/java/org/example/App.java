...
//        Reader in = new FileReader("src/main/java/resources/Sin.csv");
...
//        }
//        ln.writeToCSV("src/main/resources/input/ln.csv", -8, 5, 0.5, 0.001);
//        log2.writeToCSV("src/main/resources/input/log2.csv", -8, 5, 0.5, 0.001);
//        log3.writeToCSV("src/main/resources/input/log3.csv", -8, 5, 0.5, 0.001);
//        log5.writeToCSV("src/main/resources/input/log5.csv", -8, 5, 0.5, 0.001);
//        log10.writeToCSV("src/main/resources/input/log10.csv", -8, 5, 0.5, 0.001);
        // sin.writeToCSV("src/main/resources/input/sin.csv", -8, 5, 0.5, 0.001);
        //sin.writeToCSV("src/main/resources/input/sin1.csv", -8+Math.PI/2, 5, 0.5, 0.001);
//        cos.writeToCSV("src/main/resources/input/cos.csv", -8, 5, 0.5, 0.001);
//        cot.writeToCSV("src/main/resources/input/cot.csv", -8, 5, 0.5, 0.001);
//        csc.writeToCSV("src/main/resources/input/csc.csv", -8, 5, 0.5, 0.001);
//        sec.writeToCSV("src/main/resources/input/sec.csv", -8, 5, 0.5, 0.001);
//        function.writeToCSV("src/main/resources/input/fun.csv", -8, 5, 0.5, 0.001);
...
//        System.out.println(10 + "," + ln.result(10, 0.001));
        System.out.println(10 + "," + sin.result(10, 0.001));
